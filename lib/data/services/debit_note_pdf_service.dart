...
class DebitNotePdfService {
  const DebitNotePdfService();

  Future<Uint8List> build({
    required DebitNoteModel note,
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  pw.Text(note.debitNoteNumber),
                  pw.Text(_date(note.debitNoteDate)),
                  pw.Text('Against ${note.billNumber}'),
                ],
              ),
            ],
          ),
  ...
  String fileName(DebitNoteModel note) =>
      'DebitNote_${_safe(note.debitNoteNumber)}.pdf';
  ...
  Future<void> share({
    ...
    await SharePlus.instance.share(
      ShareParams(files: [XFile(file.path)], subject: note.debitNoteNumber),
    );
  }
