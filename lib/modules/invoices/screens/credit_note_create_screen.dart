...
class CreditNoteCreateScreen extends GetView<CreditNoteCreateController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const AppBarTitle('Credit note', subtitle: 'Sales return'),
      ),
                  ...
                  children: [
                    ...
                    AppAmountColumn(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        AppAmountText(
                          amountMinor: invoice.calculation.balanceDueMinor,
                          symbol: symbol,
                ...
                AppCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Uses this invoice’s tax treatment.',
                        style: AppTextStyles.caption.copyWith(
                          color: AppColors.textSecondary,
                        ),
                      ),
                ...
                child: Column(
                  children: [
                    ...
                    AppDropdownField<String>(
                      ...
                      options: [
                        for (final reason
                            in CreditNoteCreateController.reasonPresets)
                ...
                AppCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      AppDropdownField<CreditNoteRemainderAction>(
                        label: 'Remainder',
                        value: controller.remainder.value,
                        options: const [
                          AppDropdownOption(
                            value: CreditNoteRemainderAction.applyThenKeep,
                            label: 'Keep as customer credit',
                          ),
                          AppDropdownOption(
                            value: CreditNoteRemainderAction.applyThenRefund,
                            label: 'Refund the remainder',
                          ),
                        ],
                        onChanged: (value) =>
                      ...
                      if (controller.remainder.value ==
                          CreditNoteRemainderAction.applyThenRefund) ...[
                        const SizedBox(height: 12),
                        AppDropdownField<String>(
                          label: 'Refund method',
...
class _ReturnLine extends StatelessWidget {
  ...
  final CreditNoteItemDraft draft;
  final String symbol;
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      draft.invoiceItem.name,
                      style: AppTextStyles.listName.copyWith(fontSize: 15),
                    ),
                    const SizedBox(height: 3),
                    Text(
                      '$original ${draft.invoiceItem.unit} · ${CurrencyUtils.formatMinor(draft.invoiceItem.rateMinor, symbol: symbol)}',
                      style: AppTextStyles.caption.copyWith(
                        color: AppColors.textSecondary,
                      ),
                    ),
                    Text(
                      'Returnable $remaining ${draft.invoiceItem.unit}',
                      style: AppTextStyles.caption.copyWith(
                        color: AppColors.textSecondary,
                      ),
                    ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Up to $remaining ${widget.draft.invoiceItem.unit}',
          ...
          AppButton(
            ...
            onPressed: () {
              ...
              if (parsed > widget.draft.remainingScaled) {
                setState(
                  () => _error =
                      'Cannot return more than $remaining ${widget.draft.invoiceItem.unit}.',
                );
                return;
              }
