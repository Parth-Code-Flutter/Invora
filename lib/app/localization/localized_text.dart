...
String l10n(String? value) => AppLocalizer.text(value);
  ...
  material.Widget build(material.BuildContext context) {
    if (textSpan != null) {
      return material.Text.rich(
        AppLocalizer.span(textSpan!, locale: locale),
        style: style,
        ...
        semanticsLabel: semanticsLabel == null
            ? null
            : AppLocalizer.text(semanticsLabel, locale: locale),
    ...
    return material.Text(
      AppLocalizer.text(data, locale: locale),
      style: style,
      strutStyle: strutStyle,
      textAlign: textAlign,
      textDirection: textDirection,
