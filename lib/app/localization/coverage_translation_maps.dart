...
const Map<String, String> appHindiCoverageTranslations = {
  ...
  'GSTIN (Goods and Services Tax ID)': 'GSTIN (माल और सेवा कर आईडी)',
  '24AAAAA0000A1Z5': '24AAAAA0000A1Z5',
  ...
  'Billing Address': 'बिलिंग पता',
  'Shop/Office no., building, street, area...':
      'दुकान/ऑफिस नं., बिल्डिंग, सड़क, इलाका...',
  'Pincode': 'पिनकोड',
  '380015': '380015',
  ...
  'Add items to continue': 'आगे बढ़ने के लिए आइटम जोड़ें',
  'Review invoice': 'इनवॉइस देखें',
  'Review estimate': 'अनुमान देखें',
  'Saved offline on phone • Ready for PDF & WhatsApp share':
      'फ़ोन पर ऑफ़लाइन सहेजा • PDF और WhatsApp शेयर के लिए तैयार',
  'GST Tax Invoice': 'GST टैक्स इनवॉइस',
  ...
  'Add Service': 'सेवा जोड़ें',
  'PAYMENT & TAX BREAKDOWN': 'भुगतान और कर विवरण',
  'Intrastate (CGST + SGST)': 'राज्य के अंदर (CGST + SGST)',
  'Interstate (IGST)': 'अंतरराज्यीय (IGST)',
  'Overall invoice discount': 'कुल इनवॉइस छूट',
  'Items Subtotal': 'आइटम उप-योग',
  'Total Invoice Amount': 'कुल इनवॉइस राशि',
  'MARK INVOICE AS': 'इनवॉइस को चिह्नित करें',
  'Part Paid': 'आंशिक भुगतान',
...
const Map<String, String> appGujaratiCoverageTranslations = {
  ...
  'GSTIN (Goods and Services Tax ID)': 'GSTIN (માલ અને સેવા કર આઈડી)',
  '24AAAAA0000A1Z5': '24AAAAA0000A1Z5',
  '98765 43210': '98765 43210',
  ...
  'Registered business name': 'નોંધાયેલ વ્યવસાયનું નામ',
  'Billing Address': 'બિલિંગ સરનામું',
  'Shop/Office no., building, street, area...':
      'દુકાન/ઑફિસ નં., બિલ્ડિંગ, શેરી, વિસ્તાર...',
  'Pincode': 'પિનકોડ',
  '380015': '380015',
  ...
  'Add items to continue': 'આગળ વધવા આઇટમ ઉમેરો',
  'Review invoice': 'ઇનવોઇસ જુઓ',
  'Review estimate': 'અંદાજ જુઓ',
  'Saved offline on phone • Ready for PDF & WhatsApp share':
      'ફોન પર ઑફલાઇન સાચવ્યું • PDF અને WhatsApp શેર માટે તૈયાર',
  'GST Tax Invoice': 'GST ટેક્સ ઇનવોઇસ',
  ...
  'Add Service': 'સેવા ઉમેરો',
  'PAYMENT & TAX BREAKDOWN': 'ચુકવણી અને કર વિગત',
  'Intrastate (CGST + SGST)': 'એક જ રાજ્યમાં (CGST + SGST)',
  'Interstate (IGST)': 'આંતરરાજ્ય (IGST)',
  'Overall invoice discount': 'કુલ ઇનવોઇસ છૂટ',
  'Items Subtotal': 'આઇટમ ઉપ-કુલ',
  'Total Invoice Amount': 'કુલ ઇનવોઇસ રકમ',
  'MARK INVOICE AS': 'ઇનવોઇસને ચિહ્નિત કરો',
